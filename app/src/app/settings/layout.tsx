...
export default function SettingsLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f8f4ef] px-6 text-[#2a241f]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-center gap-6 py-20">
        <Badge className="w-fit bg-[#2a241f] text-[#f6efe8] hover:bg-[#2a241f]">
          Settings
        </Badge>
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <h1 className={`${fraunces.className} text-3xl font-semibold`}>Ustawienia</h1>
            <p className="mt-2 text-sm text-[#6f6255]">
              Zarzadzaj profilem i dostepem do organizacji.
            </p>
          </div>
